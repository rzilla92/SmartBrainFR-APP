  ...
  "node_modules/proton-engine/build/proton.min.js"(exports, module) {
    !function(t, e) {
      ...
      var V = (t(M, [{ key: "addRenderer", value: function(t2) {
        ...
        "auto" === this._fps ? (this.dispatchEvent(M.PROTON_UPDATE), M.USE_CLOCK ? (this.then || (this.then = new Date().getTime()), this.now = new Date().getTime(), this.elapsed = 1e-3 * (this.now - this.then), this.amendChangeTabsBug(), 0 < this.elapsed && this.emittersUpdate(this.elapsed), this.then = this.now) : this.emittersUpdate(M.DEFAULT_INTERVAL), this.dispatchEvent(M.PROTON_UPDATE_AFTER)) : (this.then || (this.then = new Date().getTime()), this.now = new Date().getTime(), this.elapsed = 1e-3 * (this.now - this.then), this.elapsed > this._interval && (this.dispatchEvent(M.PROTON_UPDATE), this.emittersUpdate(this._interval), this.then = this.now - this.elapsed % this._interval * 1e3, this.dispatchEvent(M.PROTON_UPDATE_AFTER)));
        ...
        M.amendChangeTabsBug && 0.5 < this.elapsed && (this.then = new Date().getTime(), this.elapsed = 0);
      } }, { key: "getCount", value: function() {
...
// dep:particles-bg
var particles_bg_default = index_es_default;
export {
  particles_bg_default as default
};
/*!
* Proton v4.2.1
